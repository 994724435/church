...
<body>
    ...
    $sql      ="select * from mian where id =1";
    ...
    <script type="text/javascript">
        $(function () {
            ...
            // jQuery Flot Chart
            var  num = <?php  echo 12; ?>;
            var visits = [[1, num], [2, 40], [3, 45], [4, 23],[5, 55],[6, 65],[7, 61],[8, 70],[9, 65],[10, 75],[11, 57],[12, 59]];
            var visitors = [[1, 25], [2, 50], [3, 23], [4, 48],[5, 38],[6, 45],[7, 47],[8, 55],[9, 43],[10,50],[11,47],[12, 39]];
            function GetDateStr(AddDayCount) {    //获取当前月份的日期
                        var dd = new Date();
            ...
            var plot = $.plot($("#statsChart"),
                [ { data: visits, label: "身高曲线"},
                 { data: visitors, label: "PIM曲线" }], {
                    series: {
                        lines: { show: true,
                                lineWidth: 1,
                                fill: true, 
                    ...
                    xaxis: {
                        ticks: [[1, GetDateStr(-4)], [2, GetDateStr(-3)], [3, GetDateStr(-2)], [4,GetDateStr(-1)],
                                   [5,GetDateStr(0)], [6,"JUN"], 
